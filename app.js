...
var content_1 = __importDefault(require("./router/content"));
var app = express();
var router = express.Router();
var corsOption = { "Access-Control-Allow-Origin": "*",
...
app.use("/api/items", auth_1.default, content_1.default);
var port = process.env.PORT || 4000;
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, connect_1.connectdb)("mongodb+srv://jeghosa:jsureeva@cluster0.spmtchq.mongodb.net/?retryWrites=true&w=majority")];
            case 1:
                _a.sent();
